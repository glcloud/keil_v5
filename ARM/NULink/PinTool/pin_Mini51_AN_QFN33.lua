...
dofile(e.."Mini51.lua")
function get_chip_status_Mini51_AN_QFN33(n,e,e)
local a={}
...
a[3]=e
local i=ext.band(t["GCR_P5_MFP"],4096)
local o=ext.band(t["GCR_P5_MFP"],16)
e={}
e["pin_no"]="4"
e["texts"]={"P5.4"}
if i==0 and o==0 then
...
a[9]=e
local i=ext.band(t["GCR_P5_MFP"],512)
local o=ext.band(t["GCR_P5_MFP"],2)
e={}
e["pin_no"]="10"
e["texts"]={"P5.1","XTAL2"}
if i==0 and o==0 then
...
a[14]=e
local o=ext.band(t["GCR_P2_MFP"],2048)
local i=ext.band(t["GCR_P2_MFP"],8)
e={}
e["pin_no"]="15"
e["texts"]={"P2.3","PWM1"}
if o==0 and i==0 then
...
a[15]=e
local i=ext.band(t["GCR_P2_MFP"],4096)
local o=ext.band(t["GCR_P2_MFP"],16)
e={}
e["pin_no"]="16"
e["texts"]={"P2.4","PWM2"}
if i==0 and o==0 then
...
a[16]=e
local o=ext.band(t["GCR_P2_MFP"],8192)
local i=ext.band(t["GCR_P2_MFP"],32)
e={}
e["pin_no"]="17"
e["texts"]={"PWM3","P2.5"}
if o==0 and i==0 then
...
a[18]=e
local o=ext.band(t["GCR_P4_MFP"],16384)
local i=ext.band(t["GCR_P4_MFP"],64)
e={}
e["pin_no"]="19"
...
a[19]=e
local i=ext.band(t["GCR_P4_MFP"],32768)
local o=ext.band(t["GCR_P4_MFP"],128)
e={}
e["pin_no"]="20"
...
a[22]=e
local o=ext.band(t["GCR_P0_MFP"],8192)
local i=ext.band(t["GCR_P0_MFP"],32)
e={}
e["pin_no"]="23"
e["texts"]={"MOSI","P0.5"}
if o==0 and i==0 then
...
a[24]=e
local i=ext.band(t["GCR_P0_MFP"],512)
local o=ext.band(t["GCR_P0_MFP"],2)
e={}
e["pin_no"]="25"
...
e["status"]=kPinStatus_Unknown
a[28]=e
local i=ext.band(t["GCR_P1_MFP"],256)
...
a[30]=e
local o=ext.band(t["GCR_P1_MFP"],2048)
local i=ext.band(t["GCR_P1_MFP"],8)
e={}
e["pin_no"]="31"
