...
dofile(e.."NUC200.lua")
function get_chip_status_NUC240_AE_LQFP64(d,e,t,o)
local a={}
local t=read_NUC200_Registers(d,e,t,o)
local e
local o=ext.rshift(ext.band(t["GCR_ALT_MFP2"],2),1)
local n=ext.rshift(ext.band(t["GCR_ALT_MFP"],8),3)
...
local o=ext.rshift(ext.band(t["GCR_ALT_MFP"],2048),11)
local s=ext.rshift(ext.band(t["GCR_ALT_MFP1"],256),8)
local n=ext.rshift(ext.band(t["GCR_GPA_MFP"],32),5)
e={}
e["pin_no"]="49"
...
a[56]=e
local s=ext.rshift(ext.band(t["GCR_ALT_MFP2"],2),1)
local n=ext.rshift(ext.band(t["GCR_ALT_MFP"],16777216),24)
local o=ext.rshift(ext.band(t["GCR_ALT_MFP2"],4),2)
