...
dofile(e.."NUC100.lua")
function get_chip_status_NUC140_CN_LQFP48(n,t,o,e)
local a={}
local t=read_NUC100_Registers(n,t,o,e)
local e
local i=ext.band(t["GCR_ALT_MFP"],1024)
...
a[18]=e
local o=ext.band(t["GCR_GPD_MFP"],64)
e={}
e["pin_no"]="19"
e["texts"]={"PD.6","CANRX0"}
if o==0 then
...
a[19]=e
e={}
local o=ext.band(t["GCR_GPD_MFP"],128)
e["pin_no"]="20"
e["texts"]={"PD.7","CANTX0"}
if o==0 then
...
a[24]=e
local o=ext.band(t["GCR_ALT_MFP"],512)
...
a[42]=e
local o=ext.band(t["GCR_ALT_MFP"],16777216)
