...
dofile(e.."NUC100.lua")
function get_chip_status_NUC130_CN_LQFP64(h,a,e,t)
local o={}
...
if s==0 and a==0 and n==0 and i==0 then
fill_NUC100_GPIO(e,t,"B",2,nil,"GCR_ALT_MFP")
elseif s==0 and a==0 and n~=0 and i==0 then
...
o[35]=e
local i=ext.band(t["GCR_ALT_MFP"],4096)
...
o[37]=e
local i=ext.band(t["GCR_ALT_MFP"],8388608)
...
local n=ext.band(t["GCR_GPA_MFP"],4096)
e={}
e["pin_no"]="40"
...
if a==0 and i==0 and n==0 then
fill_NUC100_GPIO(e,t,"A",7,nil,"GCR_ALT_MFP")
elseif a==0 and i==0 and n~=0 then
...
local a=ext.band(t["GCR_GPB_MFP"],32768)
e={}
e["pin_no"]="57"
