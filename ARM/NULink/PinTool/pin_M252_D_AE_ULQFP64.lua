...
dofile(e.."M251.lua")
function get_chip_status_M252_D_AE_ULQFP64(i,e,t,o)
local a={}
...
e={}
e["pin_no"]="8"
e["texts"]={"PA.11","ACMP0_P0","USCI0_CLK","BPWM0_CH0","TM0_EXT"}
...
e={}
e["pin_no"]="9"
e["texts"]={"PA.10","ACMP1_P0","USCI0_DAT0","BPWM0_CH1","TM1_EXT"}
...
e={}
e["pin_no"]="10"
e["texts"]={"PA.9","USCI0_DAT1","UART1_TXD","BPWM0_CH2","TM2_EXT"}
...
e={}
e["pin_no"]="11"
e["texts"]={"PA.8","USCI0_CTL1","UART1_RXD","BPWM0_CH3","TM3_EXT","INT4"}
...
e={}
e["pin_no"]="12"
e["texts"]={"PF.6","SC0_CLK","SPI0_MOSI","TAMPER0"}
...
e={}
e["pin_no"]="13"
e["texts"]={"PF.14","PWM1_BRAKE0","PWM0_BRAKE0","PSIO0_CH3","PWM0_CH4","CLKO","TM3","INT5"}
local o=ext.band(ext.rshift(t["SYS_SYS_GPF_MFPH"],24),15)
if o==0 then
fill_M251_GPIO(e,t,"F",14)
elseif o==9 then
fill_M251_PWM(e,t,"F",14,"PWM1_BRAKE0",1)
elseif o==10 then
fill_M251_PWM(e,t,"F",14,"PWM0_BRAKE0",0)
elseif o==11 then
fill_M251_PSIO(e,t,"F",14,"PSIO0_CH3",0)
elseif o==12 then
fill_M251_PWM(e,t,"F",14,"PWM0_CH4",0,4)
elseif o==13 then
fill_M251_CLKO(e,t,"F",14,"CLKO")
e["direction"]=kPinDirection_PushPullOut
elseif o==14 then
fill_M251_TM(e,t,"F",14,"TM3",3)
elseif o==15 then
fill_M251_Normal(e,t,"F",14,"INT5")
e["highlight_color"]=kColor_EINT
e["pin_bg_color"]=kBgColor_EINT
e["direction"]=kPinDirection_In
else
...
e={}
e["pin_no"]="18"
e["texts"]={"PC.7","UART0_nCTS","I2C1_SMBAL","PWM1_CH2","BPWM1_CH0","TM0","INT3"}
...
e={}
e["pin_no"]="19"
e["texts"]={"PC.6","UART0_nRTS","I2C1_SMBSUS","PWM1_CH3","BPWM1_CH1","TM1","INT2"}
...
e={}
e["pin_no"]="20"
e["texts"]={"PA.7","UART0_TXD","I2C1_SCL","PWM1_CH4","BPWM1_CH2","ACMP0_WLAT","TM2","INT1"}
...
e={}
e["pin_no"]="21"
e["texts"]={"PA.6","UART0_RXD","I2C1_SDA","PWM1_CH5","BPWM1_CH3","ACMP1_WLAT","TM3","INT0"}
...
e={}
e["pin_no"]="26"
e["texts"]={"PA.4","QSPI0_MOSI1","SPI0_I2SMCLK","SC0_nCD","UART0_nRTS","UART0_RXD","I2C0_SDA","BPWM0_CH4","PWM0_CH1"}
...
e={}
e["pin_no"]="35"
e["texts"]={"PSIO0_CH0","PWM1_CH0","I2C1_SCL","UART2_TXD","QSPI0_MISO1","PC.5"}
...
e={}
e["pin_no"]="36"
e["texts"]={"PSIO0_CH1","PWM1_CH1","I2C1_SDA","UART2_RXD","QSPI0_MOSI1","PC.4"}
...
e={}
e["pin_no"]="37"
e["texts"]={"PSIO0_CH2","PWM1_CH2","I2C0_SMBAL","UART2_nRTS","QSPI0_SS","PC.3"}
...
e={}
e["pin_no"]="38"
e["texts"]={"PSIO0_CH3","PWM1_CH3","I2C0_SMBSUS","UART2_nCTS","QSPI0_CLK","PC.2"}
...
e={}
e["pin_no"]="41"
e["texts"]={"UART0_TXD","USCI1_CTL0","SPI0_SS","USCI0_CTL1","PD.3"}
...
e={}
e["pin_no"]="52"
e["texts"]={"TM1","QSPI0_CLK","USCI0_CTL0","SPI0_I2SMCLK","PC.14"}
...
e={}
e["pin_no"]="60"
e["texts"]={"BPWM1_CH0","SPI0_I2SMCLK","I2C1_SCL","UART0_nCTS","EADC0_CH11","PB.11"}
...
e={}
e["pin_no"]="61"
e["texts"]={"BPWM1_CH1","I2C1_SDA","UART0_nRTS","USCI1_CTL0","EADC0_CH10","PB.10"}
...
e={}
e["pin_no"]="62"
e["texts"]={"BPWM1_CH2","I2C1_SMBAL","UART1_nCTS","UART0_TXD","USCI1_CTL1","EADC0_CH9","PB.9"}
...
e={}
e["pin_no"]="63"
e["texts"]={"BPWM1_CH3","I2C1_SMBSUS","UART1_nRTS","UART0_RXD","USCI1_CLK","EADC0_CH8","PB.8"}
...
e={}
e["pin_no"]="64"
e["texts"]={"ACMP0_O","INT5","PWM1_CH4","PWM1_BRAKE0","BPWM1_CH4","UART1_TXD","USCI1_DAT0","EADC0_CH7","PB.7"}
...
e={}
e["pin_no"]="1"
e["texts"]={"PB.6","EADC0_CH6","USCI1_DAT1","UART1_RXD","BPWM1_CH5","PWM1_BRAKE1","PWM1_CH5","INT4","ACMP1_O"}
