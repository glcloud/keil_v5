...
function get_chip_status_Nano110_BN_LQFP128(n,e,e)
local a={}
local t=read_Nano100_Registers()
local e
local o=ext.rshift(ext.band(t["GCR_PE_H_MFP"],7340032),20)
e={}
e["pin_no"]="1"
e["texts"]={"PE.13","LCD_SEG27"}
if o==7 then
fill_Nano100_LCD(e,t,"E","H","LCD_SEG27")
else
...
e={}
e["pin_no"]="2"
e["texts"]={"PB.14","INT0","SC2_CD","SPI2_SS1","LCD_SEG26"}
if o==1 then
...
e={}
e["pin_no"]="3"
e["texts"]={"PB.13","EBI_AD1","LCD_SEG25"}
if o==2 then
...
e={}
e["pin_no"]="4"
e["texts"]={"PB.12","EBI_AD0","FCLKO","LCD_SEG24"}
if o==2 then
...
e={}
e["pin_no"]="9"
e["texts"]={"PA.11","I2C1_SCL","EBI_nRD","SC0_RST","SPI2_MOSI0","LCD_SEG23"}
if o==1 then
...
elseif o==7 then
fill_Nano100_LCD(e,t,"A","H","LCD_SEG23")
else
...
e={}
e["pin_no"]="10"
e["texts"]={"PA.10","I2C1_SDA","EBI_nWR","SC0_PWR","SPI2_MISO0","LCD_SEG22"}
if o==1 then
...
elseif o==7 then
fill_Nano100_LCD(e,t,"A","H","LCD_SEG22")
else
...
e={}
e["pin_no"]="11"
e["texts"]={"PA.9","I2C0_SCL","SC0_DAT","SPI2_CLK","LCD_SEG21"}
if o==1 then
...
e["texts"]={"PA.9","I2C0_SCL","SC0_UART_RXD","SPI2_CLK","LCD_SEG21"}
...
elseif o==7 then
fill_Nano100_LCD(e,t,"A","H","LCD_SEG21")
else
...
e={}
e["pin_no"]="12"
e["texts"]={"PA.8","I2C0_SDA","SC0_CLK","SPI2_SS0","LCD_SEG20"}
if o==1 then
...
e["texts"]={"PA.8","I2C0_SDA","SC0_UART_TXD","SPI2_SS0","LCD_SEG20"}
e["highlight_color"]=kColor_UART
e["pin_bg_color"]=kBgColor_UART
e["direction"]=kPinDirection_Unknown
end
...
elseif o==7 then
fill_Nano100_LCD(e,t,"A","H","LCD_SEG20")
else
fill_Nano100_GPIO(e,t,"A",8)
end
a[12]=e
local o=ext.band(t["GCR_PD_H_MFP"],7)
e={}
e["pin_no"]="13"
e["texts"]={"PD.8","LCD_SEG19"}
if o==7 then
fill_Nano100_LCD(e,t,"D","H","LCD_SEG19")
else
fill_Nano100_GPIO(e,t,"D",8)
end
a[13]=e
local o=ext.rshift(ext.band(t["GCR_PD_H_MFP"],112),4)
e={}
e["pin_no"]="14"
e["texts"]={"PD.9","LCD_SEG18"}
if o==7 then
fill_Nano100_LCD(e,t,"D","H","LCD_SEG18")
else
fill_Nano100_GPIO(e,t,"D",9)
end
a[14]=e
local o=ext.rshift(ext.band(t["GCR_PD_H_MFP"],1792),8)
e={}
e["pin_no"]="15"
e["texts"]={"PD.10","LCD_SEG17"}
if o==7 then
fill_Nano100_LCD(e,t,"D","H","LCD_SEG17")
else
fill_Nano100_GPIO(e,t,"D",10)
end
a[15]=e
local o=ext.rshift(ext.band(t["GCR_PD_H_MFP"],28672),12)
e={}
e["pin_no"]="16"
e["texts"]={"PD.11","LCD_SEG16"}
if o==7 then
fill_Nano100_LCD(e,t,"D","H","LCD_SEG16")
else
fill_Nano100_GPIO(e,t,"D",11)
end
a[16]=e
local o=ext.rshift(ext.band(t["GCR_PD_H_MFP"],458752),16)
e={}
e["pin_no"]="17"
e["texts"]={"PD.12","LCD_SEG15"}
if o==7 then
fill_Nano100_LCD(e,t,"D","H","LCD_SEG15")
else
fill_Nano100_GPIO(e,t,"D",12)
end
a[17]=e
local o=ext.rshift(ext.band(t["GCR_PD_H_MFP"],7340032),20)
e={}
e["pin_no"]="18"
e["texts"]={"PD.13","LCD_SEG14"}
if o==7 then
fill_Nano100_LCD(e,t,"D","H","LCD_SEG14")
else
...
e={}
e["pin_no"]="19"
e["texts"]={"PB.4","UART1_RXD","SC0_CD","SPI2_SS0","LCD_SEG13"}
if o==1 then
...
elseif o==7 then
fill_Nano100_LCD(e,t,"B","L","LCD_SEG13")
else
...
e={}
e["pin_no"]="20"
e["texts"]={"PB.5","UART1_TXD","SC0_RST","SPI2_CLK","LCD_SEG12"}
if o==1 then
...
elseif o==7 then
fill_Nano100_LCD(e,t,"B","L","LCD_SEG12")
else
...
e={}
e["pin_no"]="21"
e["texts"]={"PB.6","UART1_RTSn","EBI_ALE","SPI2_MISO0","LCD_SEG11"}
if o==1 then
...
fill_Nano100_SPI_IO(e,t,2,true)
elseif o==7 then
fill_Nano100_LCD(e,t,"B","L","LCD_SEG11")
else
...
e={}
e["pin_no"]="22"
e["texts"]={"PB.7","UART1_CTSn","EBI_nCS","SPI2_MOSI0","LCD_SEG10"}
if o==1 then
...
fill_Nano100_SPI_IO(e,t,2,false)
elseif o==7 then
fill_Nano100_LCD(e,t,"B","L","LCD_SEG10")
else
...
e={}
e["pin_no"]="33"
e["texts"]={"PE.12","UART1_CTSn"}
if o==7 then
fill_Nano100_UART(e,t,"E","H","UART1_CTSn",1)
else
...
e={}
e["pin_no"]="34"
e["texts"]={"PE.11","UART1_RTSn"}
if o==7 then
fill_Nano100_UART(e,t,"E","H","UART1_RTSn",1)
else
...
e={}
e["pin_no"]="35"
e["texts"]={"PE.10","UART1_TXD"}
if o==7 then
fill_Nano100_UART(e,t,"E","H","UART1_TXD",1)
else
...
e={}
e["pin_no"]="36"
e["texts"]={"PE.9","UART1_RXD"}
if o==7 then
fill_Nano100_UART(e,t,"E","H","UART1_RXD",1)
else
fill_Nano100_GPIO(e,t,"E",9)
end
a[36]=e
local o=ext.band(t["GCR_PE_H_MFP"],7)
e={}
e["pin_no"]="37"
e["texts"]={"PE.8","LCD_SEG9"}
if o==7 then
fill_Nano100_LCD(e,t,"E","H","LCD_SEG9")
else
fill_Nano100_GPIO(e,t,"E",8)
end
a[37]=e
local o=ext.rshift(ext.band(t["GCR_PE_L_MFP"],1879048192),28)
e={}
e["pin_no"]="38"
e["texts"]={"PE.7","LCD_SEG8"}
if o==7 then
fill_Nano100_LCD(e,t,"E","L","LCD_SEG8")
else
...
e={}
e["pin_no"]="44"
e["texts"]={"PB.0","UART0_RXD","SPI1_MOSI0","LCD_SEG7"}
if o==1 then
...
elseif o==7 then
fill_Nano100_LCD(e,t,"B","L","LCD_SEG7")
else
...
e={}
e["pin_no"]="45"
e["texts"]={"PB.1","UART0_TXD","SPI1_MISO0","LCD_SEG6"}
if o==1 then
...
elseif o==7 then
fill_Nano100_LCD(e,t,"B","L","LCD_SEG6")
else
...
e={}
e["pin_no"]="46"
e["texts"]={"PB.2","UART0_RTSn","EBI_nWRL","SPI1_CLK","LCD_SEG5"}
if o==1 then
...
e={}
e["pin_no"]="47"
e["texts"]={"PB.3","UART0_CTSn","EBI_nWRH","SPI1_SS0","LCD_SEG4"}
if o==1 then
...
a[47]=e
local o=ext.rshift(ext.band(t["GCR_PD_L_MFP"],117440512),24)
e={}
e["pin_no"]="48"
e["texts"]={"PD.6","LCD_SEG3"}
if o==7 then
...
a[48]=e
local o=ext.rshift(ext.band(t["GCR_PD_L_MFP"],1879048192),28)
e={}
e["pin_no"]="49"
e["texts"]={"PD.7","LCD_SEG2"}
if o==7 then
...
a[49]=e
local o=ext.rshift(ext.band(t["GCR_PD_H_MFP"],117440512),24)
e={}
e["pin_no"]="50"
e["texts"]={"PD.14","LCD_SEG1"}
if o==7 then
fill_Nano100_LCD(e,t,"D","H","LCD_SEG1")
else
fill_Nano100_GPIO(e,t,"D",14)
end
a[50]=e
local o=ext.rshift(ext.band(t["GCR_PD_H_MFP"],1879048192),28)
e={}
e["pin_no"]="51"
e["texts"]={"PD.15","LCD_SEG0"}
if o==7 then
fill_Nano100_LCD(e,t,"D","H","LCD_SEG0")
else
...
local i=ext.band(t["SC1_SCx_UACTL"],1)
local s=ext.band(t["CLK_MCLKO"],128)
e={}
e["pin_no"]="57"
e["texts"]={"PC.0","MCLKO","SPI0_SS0","I2S_LRCLK","SC1_CLK","LCD_DH1"}
if s~=0 then
...
e["texts"]={"PC.0","SPI0_SS0","I2S_LRCLK","SC1_UART_TXD","LCD_DH1"}
e["highlight_color"]=kColor_UART
e["pin_bg_color"]=kBgColor_UART
e["direction"]=kPinDirection_Unknown
end
elseif o==7 then
fill_Nano100_LCD(e,t,"C","L","LCD_DH1")
else
...
e={}
e["pin_no"]="93"
e["texts"]={"LCD_SEG39","I2C0_SDA","SC2_PWR","EBI_AD9","AD4","PA.4"}
if o==1 then
...
elseif o==7 then
fill_Nano100_LCD(e,t,"A","L","LCD_SEG39")
else
...
e={}
e["pin_no"]="94"
e["texts"]={"LCD_SEG38","I2C0_SCL","SC2_RST","EBI_AD8","AD5","PA.5"}
if o==1 then
...
elseif o==7 then
fill_Nano100_LCD(e,t,"A","L","LCD_SEG38")
else
...
e={}
e["pin_no"]="95"
e["texts"]={"LCD_SEG37","PWM0_CH3","SC2_CLK","TC3","EBI_AD7","AD6","PA.6"}
if o==1 then
...
e["texts"]={"LCD_SEG37","PWM0_CH3","SC2_UART_TXD","TC3","EBI_AD7","AD6","PA.6"}
e["highlight_color"]=kColor_UART
e["pin_bg_color"]=kBgColor_UART
e["direction"]=kPinDirection_Unknown
end
...
elseif o==7 then
fill_Nano100_LCD(e,t,"A","L","LCD_SEG37")
else
...
e={}
e["pin_no"]="96"
e["texts"]={"LCD_SEG36","CTK_CAP","PWM0_CH2","SC2_DAT","TC2","EBI_AD6","AD7","PA.7"}
if o==1 then
...
e["texts"]={"LCD_SEG36","CTK_CAP","PWM0_CH2","SC2_UART_RXD","TC2","EBI_AD6","AD7","PA.7"}
e["highlight_color"]=kColor_UART
e["pin_bg_color"]=kBgColor_UART
e["direction"]=kPinDirection_Unknown
end
...
elseif o==7 then
fill_Nano100_LCD(e,t,"A","L","LCD_SEG36")
else
...
e={}
e["pin_no"]="106"
e["texts"]={"LCD_SEG34","CTK5","SPI2_MOSI1","I2S_DO","PD.5"}
if o==2 then
...
elseif o==7 then
fill_Nano100_LCD(e,t,"D","L","LCD_SEG34")
else
...
e={}
e["pin_no"]="109"
e["texts"]={"LCD_SEG33","PWM1_CH2","TC0","EBI_AD3","PC.15"}
if o==2 then
...
elseif o==7 then
fill_Nano100_LCD(e,t,"C","H","LCD_SEG33")
else
...
e={}
e["pin_no"]="110"
e["texts"]={"LCD_SEG32","PWM1_CH3","EBI_AD2","PC.14"}
if o==2 then
...
elseif o==7 then
fill_Nano100_LCD(e,t,"C","H","LCD_SEG32")
else
...
e={}
e["pin_no"]="111"
e["texts"]={"LCD_SEG31","SNOOPER","INT1","PB.15"}
if o==1 then
...
e={}
e["pin_no"]="126"
e["texts"]={"LCD_SEG30","SC2_PWR","INT0","TM0","STADC","PB.8"}
if o==1 then
...
elseif o==7 then
fill_Nano100_LCD(e,t,"B","H","LCD_SEG30")
else
fill_Nano100_GPIO(e,t,"B",8)
end
a[126]=e
local o=ext.rshift(ext.band(t["GCR_PE_H_MFP"],1879048192),28)
e={}
e["pin_no"]="127"
e["texts"]={"LCD_SEG29","PE.15"}
if o==7 then
...
a[127]=e
local o=ext.rshift(ext.band(t["GCR_PE_H_MFP"],117440512),24)
e={}
e["pin_no"]="128"
e["texts"]={"LCD_SEG28","PE.14"}
if o==7 then
fill_Nano100_LCD(e,t,"E","H","LCD_SEG28")
else
