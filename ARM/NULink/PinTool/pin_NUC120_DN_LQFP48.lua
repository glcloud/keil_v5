...
dofile(e.."NUC100.lua")
function get_chip_status_NUC120_DN_LQFP48(r,e,o,t)
local a={}
...
elseif o==0 and i==0 and n==1 and s==0 then
...
elseif o==1 and i==1 and n==1 and s==0 then
fill_NUC100_EBI(e,t,"B",2,"nWRL","GCR_ALT_MFP")
else
fill_invalid_GPIO(e,t,"B",2,"GCR_ALT_MFP")
end
a[19]=e
local i=ext.rshift(ext.band(t["GCR_ALT_MFP"],16384),14)
...
if i==0 and h==0 and n==0 and s==0 and o==0 then
fill_NUC100_GPIO(e,t,"B",3,nil,"GCR_ALT_MFP","GCR_ALT_MFP1")
elseif i==0 and h==0 and n==0 and s==0 and o==1 then
fill_NUC100_UART(e,t,"B",3,"CTS0",0,"GCR_ALT_MFP","GCR_ALT_MFP1")
elseif i==0 and h==0 and n==0 and s==1 and o==1 then
fill_NUC100_TM(e,t,"B",3,"T3EX",3,"GCR_ALT_MFP","GCR_ALT_MFP1")
elseif i==0 and h==0 and n==1 and s==0 and o==1 then
fill_NUC100_SC(e,t,"B",3,"SC2CD",2,"GCR_ALT_MFP","GCR_ALT_MFP1")
e["direction"]=kPinDirection_In
elseif i==1 and h==1 and n==0 and s==0 and o==1 then
...
local o=ext.rshift(ext.band(t["GCR_ALT_MFP"],2048),11)
local n=ext.rshift(ext.band(t["GCR_ALT_MFP1"],2048),11)
...
local i=ext.rshift(ext.band(t["GCR_ALT_MFP"],2048),11)
local s=ext.rshift(ext.band(t["GCR_ALT_MFP1"],2),1)
...
a[38]=e
local n=ext.rshift(ext.band(t["GCR_ALT_MFP"],2048),11)
local s=ext.rshift(ext.band(t["GCR_ALT_MFP1"],64),6)
