...
dofile(e.."NUC200.lua")
function get_chip_status_NUC240_AE_LQFP100(d,e,o,t)
local a={}
local t=read_NUC200_Registers(d,e,o,t)
local e
e={}
e["pin_no"]="1"
e["texts"]={"PE.15"}
...
local r=ext.rshift(ext.band(t["GCR_ALT_MFP2"],16),4)
...
e={}
e["pin_no"]="34"
e["texts"]={"PB.2","nWRL","UART0_nRTS","TM2_EXT","TM2","ACMP0_O"}
if s==0 and h==0 and r==0 and n==0 and o==0 and i==0 then
fill_NUC200_GPIO(e,t,"B",2,nil,"GCR_ALT_MFP","GCR_ALT_MFP2")
elseif s==1 and h==1 and r==0 and n==0 and o==0 and i==1 then
fill_NUC200_EBI(e,t,"B",2,"nWRL","GCR_ALT_MFP","GCR_ALT_MFP2")
elseif s==0 and h==0 and r==0 and n==0 and o==0 and i==1 then
fill_NUC200_UART(e,t,"B",2,"UART0_nRTS",0,"GCR_ALT_MFP","GCR_ALT_MFP2")
elseif s==0 and h==0 and r==0 and n==0 and o==1 and i==1 then
fill_NUC200_TM(e,t,"B",2,"TM2_EXT",2,"GCR_ALT_MFP","GCR_ALT_MFP2")
elseif s==0 and h==0 and r==1 and n==0 and o==0 and i==1 then
fill_NUC200_TM(e,t,"B",2,"TM2",2,"GCR_ALT_MFP","GCR_ALT_MFP2")
elseif s==0 and h==0 and r==0 and n==1 and o==0 and i==1 then
...
e={}
e["pin_no"]="35"
e["texts"]={"PB.3","UART0_nCTS","nWRH","TM3_EXT","TM3","SC2_CD"}
if o==0 and i==0 and n==0 and r==0 and s==0 and h==0 then
fill_NUC200_GPIO(e,t,"B",3,nil,"GCR_ALT_MFP","GCR_ALT_MFP1","GCR_ALT_MFP2")
elseif o==0 and i==0 and n==0 and r==0 and s==0 and h==1 then
fill_NUC200_UART(e,t,"B",3,"UART0_nCTS",0,"GCR_ALT_MFP","GCR_ALT_MFP1","GCR_ALT_MFP2")
elseif o==1 and i==1 and n==0 and r==0 and s==0 and h==1 then
fill_NUC200_EBI(e,t,"B",3,"nWRH","GCR_ALT_MFP","GCR_ALT_MFP1","GCR_ALT_MFP2")
elseif o==0 and i==0 and n==0 and r==0 and s==1 and h==1 then
fill_NUC200_TM(e,t,"B",3,"TM3_EXT",3,"GCR_ALT_MFP","GCR_ALT_MFP1","GCR_ALT_MFP2")
elseif o==0 and i==0 and n==1 and r==0 and s==0 and h==1 then
fill_NUC200_TM(e,t,"B",3,"TM3",3,"GCR_ALT_MFP","GCR_ALT_MFP1","GCR_ALT_MFP2")
elseif o==0 and i==0 and n==0 and r==1 and s==0 and h==1 then
...
a[37]=e
local o=ext.band(t["GCR_ALT_MFP2"],1)
...
local n=ext.rshift(ext.band(t["GCR_ALT_MFP1"],8192),13)
local o=ext.rshift(ext.band(t["GCR_GPA_MFP"],16384),14)
e={}
e["pin_no"]="63"
e["texts"]={"SC2_RST","AD15","PWM2","PA.14"}
...
e={}
e["pin_no"]="64"
e["texts"]={"UART5_TXD","SC2_CLK","AD14","PWM1","PA.13"}
...
e={}
e["pin_no"]="65"
e["texts"]={"UART5_RXD","SC2_DAT","AD13","PWM0","PA.12"}
...
if s==0 and o==0 and n==0 and i==0 then
fill_NUC200_GPIO(e,t,"A",2,nil,"GCR_ALT_MFP","GCR_ALT_MFP1")
elseif s==0 and o==0 and n==0 and i==1 then
fill_NUC200_ADC(e,t,"A",2,"ADC2","GCR_ALT_MFP","GCR_ALT_MFP1")
elseif s==0 and o==0 and n==1 and i==1 then
if h==0 then
...
elseif s==1 and o==1 and n==0 and i==1 then
...
a[73]=e
local n=ext.rshift(ext.band(t["GCR_ALT_MFP"],262144),18)
local s=ext.rshift(ext.band(t["GCR_ALT_MFP"],2048),11)
...
elseif n==1 and s==1 and o==0 and i==1 then
...
local i=ext.rshift(ext.band(t["GCR_ALT_MFP"],2048),11)
local n=ext.rshift(ext.band(t["GCR_ALT_MFP1"],128),7)
...
local s=ext.rshift(ext.band(t["GCR_ALT_MFP"],2048),11)
local n=ext.rshift(ext.band(t["GCR_ALT_MFP1"],256),8)
...
local s=ext.rshift(ext.band(t["GCR_ALT_MFP"],4),2)
local o=ext.rshift(ext.band(t["GCR_GPA_MFP"],128),7)
local h=ext.band(t["SC1_SC_UACTL"],1)
e={}
e["pin_no"]="78"
e["texts"]={"SPI2_SS1","UART4_RXD","SC1_DAT","AD6","ADC7","PA.7"}
...
elseif i==1 and n==0 and s==0 and o==1 then
fill_NUC200_EBI(e,t,"A",7,"AD6","GCR_ALT_MFP","GCR_ALT_MFP1")
e["direction"]=kPinDirection_Bi
elseif i==0 and n==1 and s==0 and o==1 then
if h==0 then
fill_NUC200_SC(e,t,"A",7,"SC1_DAT",1,"GCR_ALT_MFP","GCR_ALT_MFP1","SC1_SC_UACTL")
else
fill_NUC200_SC(e,t,"A",7,"UART4_RXD",1,"GCR_ALT_MFP","GCR_ALT_MFP1","SC1_SC_UACTL")
e["highlight_color"]=kColor_UART
e["pin_bg_color"]=kBgColor_UART
e["direction"]=kPinDirection_Unknown
end
...
a[90]=e
local o=ext.rshift(ext.band(t["GCR_ALT_MFP2"],2),1)
local s=ext.rshift(ext.band(t["GCR_ALT_MFP"],16777216),24)
...
elseif o==0 and s==0 and i==0 and n==1 then
fill_NUC200_Normal(e,t,"B",15,"INT1","GCR_ALT_MFP","GCR_ALT_MFP2")
e["highlight_color"]=kColor_EINT
e["pin_bg_color"]=kBgColor_EINT
e["direction"]=kPinDirection_In
elseif o==0 and s==1 and i==0 and n==1 then
...
elseif o==1 and s==0 and i==0 and n==1 then
