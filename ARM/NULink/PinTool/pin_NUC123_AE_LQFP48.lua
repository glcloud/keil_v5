...
dofile(e.."NUC123.lua")
function get_chip_status_NUC123_AE_LQFP48(i,e,o,t)
local a={}
local t=read_NUC123_Registers(i,e,o,t)
local e
...
local a=ext.rshift(ext.band(t["GCR_GPA_MFP"],1024),10)
...
local a=ext.rshift(ext.band(t["GCR_GPB_MFP"],64),6)
...
local a=ext.rshift(ext.band(t["GCR_GPB_MFP"],128),7)
...
local a=ext.rshift(ext.band(t["GCR_ALT_MFP"],1073741824),30)
if a==0 and o==0 then
...
local a=ext.rshift(ext.band(t["GCR_GPC_MFP"],4),2)
...
local a=ext.rshift(ext.band(t["GCR_ALT_MFP"],32),5)
if a==0 and o==0 then
...
local a=ext.rshift(ext.band(t["GCR_GPC_MFP"],256),8)
local o=ext.rshift(ext.band(t["GCR_ALT_MFP1"],8388608),23)
if o==0 and a==0 then
...
local a=ext.rshift(ext.band(t["GCR_GPA_MFP"],32768),15)
...
local a=ext.band(t["GCR_GPD_MFP"],1)
...
local a=ext.rshift(ext.band(t["GCR_ALT_MFP1"],131072),17)
if a==0 and o==0 then
...
local a=ext.rshift(ext.band(t["GCR_ALT_MFP1"],1048576),20)
if a==0 and o==0 then
...
local a=ext.rshift(ext.band(t["GCR_ALT_MFP1"],2097152),21)
if a==0 and o==0 then
...
local a=ext.rshift(ext.band(t["GCR_GPF_MFP"],8),3)
