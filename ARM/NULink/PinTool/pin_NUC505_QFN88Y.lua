...
dofile(e.."NUC505.lua")
function get_chip_status_NUC505_QFN88Y(i,e,t,o)
local a={}
local t=read_NUC505_Registers(i,e,t,o)
local e
e={}
e["pin_no"]="1"
e["texts"]={"nRESET"}
...
a[7]=e
local o=ext.rshift(ext.band(t["GCR_SYS_GPC_MFPL"],112),4)
e={}
e["pin_no"]="8"
e["texts"]={"PC.1","SD_CLK"}
if o==0 then
fill_NUC505_GPIO(e,t,"C",1)
elseif o==1 then
fill_NUC505_SD(e,t,"C",1,"SD_CLK")
else
fill_invalid_GPIO(e,t,"C",1)
end
a[8]=e
local o=ext.rshift(ext.band(t["GCR_SYS_GPC_MFPL"],1792),8)
e={}
e["pin_no"]="9"
e["texts"]={"PC.2","SD_nCD"}
if o==0 then
fill_NUC505_GPIO(e,t,"C",2)
elseif o==1 then
fill_NUC505_SD(e,t,"C",2,"SD_nCD")
else
...
a[10]=e
local o=ext.rshift(ext.band(t["GCR_SYS_GPC_MFPL"],28672),12)
e={}
e["pin_no"]="11"
e["texts"]={"PC.3"}
if o==0 then
fill_NUC505_GPIO(e,t,"C",3)
else
fill_invalid_GPIO(e,t,"C",3)
end
a[11]=e
local o=ext.rshift(ext.band(t["GCR_SYS_GPC_MFPL"],458752),16)
e={}
e["pin_no"]="12"
e["texts"]={"PC.4","SD_DAT0"}
if o==0 then
fill_NUC505_GPIO(e,t,"C",4)
elseif o==1 then
fill_NUC505_SD(e,t,"C",4,"SD_DAT0")
else
fill_invalid_GPIO(e,t,"C",4)
end
a[12]=e
local o=ext.rshift(ext.band(t["GCR_SYS_GPC_MFPL"],7340032),20)
e={}
e["pin_no"]="13"
e["texts"]={"PC.5","SD_DAT1"}
if o==0 then
fill_NUC505_GPIO(e,t,"C",5)
elseif o==1 then
fill_NUC505_SD(e,t,"C",5,"SD_DAT1")
else
fill_invalid_GPIO(e,t,"C",5)
end
a[13]=e
local o=ext.rshift(ext.band(t["GCR_SYS_GPC_MFPL"],117440512),24)
e={}
e["pin_no"]="14"
e["texts"]={"PC.6","SD_DAT2"}
if o==0 then
fill_NUC505_GPIO(e,t,"C",6)
elseif o==1 then
fill_NUC505_SD(e,t,"C",6,"SD_DAT2")
else
...
e["pin_no"]="26"
e["texts"]={"X32_IN"}
fill_NUC505_Normal(e,t,nil,nil,"X32_IN")
e["direction"]=kPinDirection_In
a[26]=e
e={}
e["pin_no"]="27"
e["texts"]={"X32_OUT"}
fill_NUC505_Normal(e,t,nil,nil,"X32_OUT")
e["direction"]=kPinDirection_PushPullOut
a[27]=e
...
a[35]=e
local o=ext.rshift(ext.band(t["GCR_SYS_GPC_MFPL"],1879048192),28)
e={}
e["pin_no"]="36"
e["texts"]={"PC.7","SD_DAT3"}
if o==0 then
fill_NUC505_GPIO(e,t,"C",7)
elseif o==1 then
fill_NUC505_SD(e,t,"C",7,"SD_DAT3")
else
fill_invalid_GPIO(e,t,"C",7)
end
a[36]=e
local o=ext.band(t["GCR_SYS_GPC_MFPH"],7)
e={}
e["pin_no"]="37"
e["texts"]={"PC.8","I2S_MCLK"}
if o==0 then
fill_NUC505_GPIO(e,t,"C",8)
elseif o==1 then
fill_NUC505_I2S(e,t,"C",8,"I2S_MCLK",0)
else
fill_invalid_GPIO(e,t,"C",8)
end
a[37]=e
local o=ext.rshift(ext.band(t["GCR_SYS_GPC_MFPH"],112),4)
e={}
e["pin_no"]="38"
e["texts"]={"PC.9","I2S_DI","TM2_CNT_OUT","PWM_CH0"}
if o==0 then
fill_NUC505_GPIO(e,t,"C",9)
elseif o==1 then
fill_NUC505_I2S(e,t,"C",9,"I2S_DI",0)
elseif o==2 then
fill_NUC505_TM(e,t,"C",9,"TM2_CNT_OUT",2)
elseif o==3 then
fill_NUC505_PWM(e,t,"C",9,"PWM_CH0",0)
else
fill_invalid_GPIO(e,t,"C",9)
end
a[38]=e
local o=ext.rshift(ext.band(t["GCR_SYS_GPC_MFPH"],1792),8)
e={}
e["pin_no"]="39"
e["texts"]={"PC.10","I2S_DO","TM2_EXT","PWM_CH1"}
if o==0 then
fill_NUC505_GPIO(e,t,"C",10)
elseif o==1 then
fill_NUC505_I2S(e,t,"C",10,"I2S_DO",0)
elseif o==2 then
fill_NUC505_TM(e,t,"C",10,"TM2_EXT",2)
elseif o==3 then
fill_NUC505_PWM(e,t,"C",10,"PWM_CH1",1)
else
...
e={}
e["pin_no"]="51"
e["texts"]={"SD_DAT3","UART1_nRTS","TM1_EXT","USBH_VOD","PB.9"}
if o==0 then
fill_NUC505_GPIO(e,t,"B",9)
elseif o==1 then
fill_NUC505_Normal(e,t,"B",9,"USBH_VOD")
e["highlight_color"]=kColor_USB
e["pin_bg_color"]=kBgColor_USB
elseif o==2 then
...
e["pin_no"]="55"
e["texts"]={"VCMBF"}
fill_NUC505_Normal(e,t,nil,nil,"VCMBF")
a[55]=e
e={}
e["pin_no"]="56"
e["texts"]={"RHPOUT"}
...
fill_NUC505_Normal(e,t,nil,nil,"VDD12")
a[63]=e
local o=ext.rshift(ext.band(t["GCR_SYS_GPD_MFPL"],1792),8)
e={}
e["pin_no"]="64"
e["texts"]={"MIC1_P","PD.2"}
if o==0 then
fill_NUC505_GPIO(e,t,"D",2)
elseif o==1 then
fill_NUC505_Normal(e,t,"D",2,"MIC1_P")
e["direction"]=kPinDirection_In
else
fill_invalid_GPIO(e,t,"D",2)
end
a[64]=e
local o=ext.rshift(ext.band(t["GCR_SYS_GPD_MFPL"],28672),12)
e={}
e["pin_no"]="65"
e["texts"]={"MIC1_N","PD.3"}
if o==0 then
fill_NUC505_GPIO(e,t,"D",3)
elseif o==1 then
fill_NUC505_Normal(e,t,"D",3,"MIC1_N")
e["direction"]=kPinDirection_In
else
...
fill_NUC505_Normal(e,t,nil,nil,"VDD")
a[81]=e
local o=ext.rshift(ext.band(t["GCR_SYS_GPC_MFPH"],28672),12)
e={}
e["pin_no"]="82"
e["texts"]={"PWM_CH2","TM3_CNT_OUT","I2S_LRCLK","PC.11"}
if o==0 then
fill_NUC505_GPIO(e,t,"C",11)
elseif o==1 then
fill_NUC505_I2S(e,t,"C",11,"I2S_LRCLK",0)
elseif o==2 then
fill_NUC505_TM(e,t,"C",11,"TM3_CNT_OUT",3)
elseif o==3 then
fill_NUC505_PWM(e,t,"C",11,"PWM_CH2",2)
else
fill_invalid_GPIO(e,t,"C",11)
end
a[82]=e
local o=ext.rshift(ext.band(t["GCR_SYS_GPC_MFPH"],458752),16)
e={}
e["pin_no"]="83"
e["texts"]={"PWM_CH3","TM3_EXT","I2S_BCLK","PC.12"}
if o==0 then
fill_NUC505_GPIO(e,t,"C",12)
elseif o==1 then
fill_NUC505_I2S(e,t,"C",12,"I2S_BCLK",0)
elseif o==2 then
fill_NUC505_TM(e,t,"C",12,"TM3_EXT",3)
elseif o==3 then
fill_NUC505_PWM(e,t,"C",12,"PWM_CH3",3)
else
fill_invalid_GPIO(e,t,"C",12)
end
a[83]=e
local o=ext.rshift(ext.band(t["GCR_SYS_GPC_MFPH"],7340032),20)
e={}
e["pin_no"]="84"
e["texts"]={"USBH2_D+","PC.13"}
if o==0 then
fill_NUC505_GPIO(e,t,"C",13)
elseif o==1 then
fill_NUC505_USBH(e,t,"C",13,"USBH2_D+")
else
fill_invalid_GPIO(e,t,"C",13)
end
a[84]=e
local o=ext.rshift(ext.band(t["GCR_SYS_GPC_MFPH"],117440512),24)
e={}
e["pin_no"]="85"
e["texts"]={"USBH2_D-","PC.14"}
if o==0 then
fill_NUC505_GPIO(e,t,"C",14)
elseif o==1 then
fill_NUC505_USBH(e,t,"C",14,"USBH2_D-")
else
