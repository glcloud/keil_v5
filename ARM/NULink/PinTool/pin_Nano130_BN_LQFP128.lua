...
function get_chip_status_Nano130_BN_LQFP128(n,e,e)
local a={}
...
e={}
e["pin_no"]="105"
e["texts"]={"LCD_SEG35","CTK4","SC1_CD","SPI2_MISO1","I2S_DI","PD.4"}
if o==2 then
...
elseif o==7 then
fill_Nano100_LCD(e,t,"D","L","LCD_SEG35")
else
...
e={}
e["pin_no"]="111"
e["texts"]={"LCD_SEG31","SC1_CD","SNOOPER","INT1","PB.15"}
if o==1 then
