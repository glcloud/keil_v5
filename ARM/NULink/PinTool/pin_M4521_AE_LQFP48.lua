...
dofile(e.."M4521.lua")
function get_chip_status_M4521_AE_LQFP48(i,e,t,o)
local a={}
local t=read_M4521_Registers(i,e,t,o)
local e
...
e={}
e["pin_no"]="5"
e["texts"]={"PD.0","EADC_CH6","UART0_RXD","INT3"}
if o==0 then
...
e={}
e["pin_no"]="24"
e["texts"]={"PE.0","I2C1_SDA","T2_EXT","SC0_CD","PWM0_CH0","EBI_nCS1","INT4"}
if o==0 then
fill_M4521_GPIO(e,t,"E",0)
elseif o==3 then
fill_M4521_I2C(e,t,"E",0,"I2C1_SDA",1)
elseif o==4 then
fill_M4521_TM(e,t,"E",0,"T2_EXT",2)
elseif o==5 then
fill_M4521_SC(e,t,"E",0,"SC0_CD",0)
e["direction"]=kPinDirection_In
elseif o==6 then
fill_M4521_PWM(e,t,"E",0,"PWM0_CH0",0,0)
elseif o==7 then
fill_M4521_EBI(e,t,"E",0,"EBI_nCS1")
e["direction"]=kPinDirection_PushPullOut
elseif o==8 then
fill_M4521_Normal(e,t,"E",0,"INT4")
e["highlight_color"]=kColor_EINT
e["pin_bg_color"]=kBgColor_EINT
e["direction"]=kPinDirection_In
else
