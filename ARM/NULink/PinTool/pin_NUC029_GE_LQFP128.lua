...
dofile(e.."M0564.lua")
function get_chip_status_NUC029_GE_LQFP128(i,t,o,e)
local a={}
local t=read_M0564_Registers(i,t,o,e)
local e
...
elseif o==5 then
fill_M0564_ACMP(e,t,"B",15,"ACMP0_P3",0)
elseif o==7 then
...
e["pin_no"]="10"
e["texts"]={"NC"}
fill_M0564_Normal(e,t,nil,nil,"NC")
a[10]=e
e={}
e["pin_no"]="11"
e["texts"]={"VDD"}
...
elseif o==5 then
fill_M0564_ACMP(e,t,"D",9,"ACMP1_P3",1)
elseif o==6 then
...
e["direction"]=kPinDirection_PushPullOut
elseif o==5 then
fill_M0564_ACMP(e,t,"D",6,"ACMP0_O",0)
e["direction"]=kPinDirection_PushPullOut
elseif o==6 then
...
e={}
e["pin_no"]="65"
e["texts"]={"INT4","EBI_nCS1","PWM0_CH0","SC0_nCD","TM2_EXT","I2C1_SDA","SPI0_CLK","PE.0"}
if o==0 then
...
fill_M0564_USCI_IO(e,t,0,1)
elseif o==5 then
fill_M0564_ACMP(e,t,"C",6,"ACMP1_O",1)
e["direction"]=kPinDirection_PushPullOut
elseif o==6 then
...
e={}
e["pin_no"]="75"
e["texts"]={"SC1_DAT","UART1_nCTS","PA.10"}
if o==0 then
fill_M0564_GPIO(e,t,"A",10)
elseif o==3 then
fill_M0564_UART(e,t,"A",10,"UART1_nCTS",1)
elseif o==5 then
fill_M0564_SC(e,t,"A",10,"SC1_DAT",1)
e["direction"]=kPinDirection_Bi
local t=ext.band(t["SC1_SC_UARTCTL"],1)
if t~=0 then
e["direction"]=kPinDirection_In
...
e={}
e["pin_no"]="76"
e["texts"]={"SC1_CLK","UART1_nRTS","PA.11"}
if o==0 then
fill_M0564_GPIO(e,t,"A",11)
elseif o==3 then
fill_M0564_UART(e,t,"A",11,"UART1_nRTS",1)
elseif o==5 then
fill_M0564_SC(e,t,"A",11,"SC1_CLK",1)
local t=ext.band(t["SC1_SC_UARTCTL"],1)
if t~=0 then
e["direction"]=kPinDirection_PushPullOut
end
...
e={}
e["pin_no"]="77"
e["texts"]={"TM_BRAKE0","SC1_nCD","TM3_EXT","PF.5"}
if o==0 then
fill_M0564_GPIO(e,t,"F",5)
elseif o==3 then
fill_M0564_TM(e,t,"F",5,"TM3_EXT",3)
elseif o==5 then
fill_M0564_SC(e,t,"F",5,"SC1_nCD",1)
e["direction"]=kPinDirection_In
elseif o==6 then
fill_M0564_TM(e,t,"F",5,"TM_BRAKE0",0)
else
...
if o==0 then
fill_M0564_GPIO(e,t,"C",15)
elseif o==6 then
fill_M0564_PWM(e,t,"C",15,"PWM1_CH0",1,0)
else
