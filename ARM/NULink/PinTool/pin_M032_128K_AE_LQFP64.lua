...
dofile(e.."M031.lua")
function get_chip_status_M032_128K_AE_LQFP64(i,e,t,o)
local a={}
...
e={}
e["pin_no"]="1"
e["texts"]={"PB.6","EADC0_CH6","EBI_nWRH","UART1_RXD","EBI_nCS1","PWM1_BRAKE1","PWM1_CH5","INT4","ACMP1_O"}
if o==0 then
...
e={}
e["pin_no"]="12"
e["texts"]={"PF.6","EBI_ADR19","SPI0_MOSI","EBI_nCS0"}
if o==0 then
fill_M031_GPIO(e,t,"F",6)
elseif o==2 then
fill_M031_EBI(e,t,"F",6,"EBI_ADR19")
e["direction"]=kPinDirection_PushPullOut
elseif o==5 then
fill_M031_SPI(e,t,"F",6,"SPI0_MOSI",0)
fill_M031_SPI_IO(e,t,0,false)
elseif o==7 then
fill_M031_EBI(e,t,"F",6,"EBI_nCS0")
e["direction"]=kPinDirection_PushPullOut
else
...
e={}
e["pin_no"]="18"
e["texts"]={"PC.7","EBI_AD9","UART0_nCTS","PWM1_CH2","TM0","INT3"}
if o==0 then
fill_M031_GPIO(e,t,"C",7)
elseif o==2 then
fill_M031_EBI(e,t,"C",7,"EBI_AD9")
...
e={}
e["pin_no"]="19"
e["texts"]={"PC.6","EBI_AD8","UART0_nRTS","PWM1_CH3","TM1","INT2"}
if o==0 then
fill_M031_GPIO(e,t,"C",6)
elseif o==2 then
fill_M031_EBI(e,t,"C",6,"EBI_AD8")
e["direction"]=kPinDirection_Bi
elseif o==7 then
...
e={}
e["pin_no"]="41"
e["texts"]={"UART0_TXD","SPI0_SS","USCI0_CTL1","EBI_AD10","PD.3"}
if o==0 then
fill_M031_GPIO(e,t,"D",3)
elseif o==2 then
fill_M031_EBI(e,t,"D",3,"EBI_AD10")
e["direction"]=kPinDirection_Bi
elseif o==3 then
...
elseif o==2 then
fill_M031_EBI(e,t,"D",2,"EBI_AD11")
e["direction"]=kPinDirection_Bi
elseif o==3 then
...
elseif o==2 then
fill_M031_EBI(e,t,"D",1,"EBI_AD12")
e["direction"]=kPinDirection_Bi
elseif o==3 then
...
elseif o==2 then
fill_M031_EBI(e,t,"D",0,"EBI_AD13")
e["direction"]=kPinDirection_Bi
elseif o==3 then
...
e["pin_no"]="45"
e["texts"]={"USB_VBUS"}
fill_M031_Normal(e,t,nil,nil,"USB_VBUS")
...
e["pin_no"]="46"
e["texts"]={"USB_D-"}
fill_M031_USB(e,t,nil,nil,"USB_D-")
a[46]=e
e={}
e["pin_no"]="47"
e["texts"]={"USB_D+"}
...
fill_M031_Normal(e,t,nil,nil,"USB_VDD33_CAP")
e["highlight_color"]=kColor_USB
e["pin_bg_color"]=kBgColor_USB
a[48]=e
e={}
...
e={}
e["pin_no"]="60"
e["texts"]={"SPI0_I2SMCLK","I2C1_SCL","UART0_nCTS","EBI_ADR16","EADC0_CH11","PB.11"}
if o==0 then
fill_M031_GPIO(e,t,"B",11)
elseif o==1 then
fill_M031_EADC(e,t,"B",11,"EADC0_CH11")
elseif o==2 then
fill_M031_EBI(e,t,"B",11,"EBI_ADR16")
e["direction"]=kPinDirection_PushPullOut
elseif o==5 then
...
e={}
e["pin_no"]="61"
e["texts"]={"I2C1_SDA","UART0_nRTS","EBI_ADR17","EADC0_CH10","PB.10"}
if o==0 then
fill_M031_GPIO(e,t,"B",10)
elseif o==1 then
fill_M031_EADC(e,t,"B",10,"EADC0_CH10")
elseif o==2 then
fill_M031_EBI(e,t,"B",10,"EBI_ADR17")
e["direction"]=kPinDirection_PushPullOut
elseif o==5 then
...
e={}
e["pin_no"]="62"
e["texts"]={"UART1_nCTS","UART0_TXD","EBI_ADR18","EADC0_CH9","PB.9"}
if o==0 then
fill_M031_GPIO(e,t,"B",9)
elseif o==1 then
fill_M031_EADC(e,t,"B",9,"EADC0_CH9")
elseif o==2 then
fill_M031_EBI(e,t,"B",9,"EBI_ADR18")
e["direction"]=kPinDirection_PushPullOut
elseif o==5 then
...
e={}
e["pin_no"]="63"
e["texts"]={"UART1_nRTS","UART0_RXD","EBI_ADR19","EADC0_CH8","PB.8"}
if o==0 then
fill_M031_GPIO(e,t,"B",8)
elseif o==1 then
fill_M031_EADC(e,t,"B",8,"EADC0_CH8")
elseif o==2 then
fill_M031_EBI(e,t,"B",8,"EBI_ADR19")
e["direction"]=kPinDirection_PushPullOut
elseif o==5 then
