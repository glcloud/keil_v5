...
function get_chip_status_Nano112_AN_LQFP64(i,t,e,o)
local a={}
...
e={}
e["pin_no"]="1"
e["texts"]={"PB.10","LCD_SEG24","UART1_RXD","SPI0_MOSI1"}
if o==8 then
...
e={}
e["pin_no"]="2"
e["texts"]={"PB.11","LCD_SEG23","UART1_RTSn","SPI0_MISO1","TM1"}
if o==8 then
...
e={}
e["pin_no"]="3"
e["texts"]={"PB.12","LCD_SEG22","UART0_RTSn","SPI0_MOSI0","TM0","FCLK0"}
if o==8 then
fill_Nano100_LCD(e,t,"B","H","LCD_SEG22")
elseif o==7 then
...
e={}
e["pin_no"]="4"
e["texts"]={"PB.13","LCD_SEG21","UART0_RXD","SPI0_MISO0"}
if o==8 then
fill_Nano100_LCD(e,t,"B","H","LCD_SEG21")
elseif o==7 then
...
e={}
e["pin_no"]="5"
e["texts"]={"PB.14","LCD_SEG20","UART0_TXD","SPI0_CLK"}
if o==8 then
fill_Nano100_LCD(e,t,"B","H","LCD_SEG20")
elseif o==7 then
...
e={}
e["pin_no"]="6"
e["texts"]={"PB.15","LCD_SEG19","UART0_CTSn","SPI0_SS0"}
if o==8 then
fill_Nano100_LCD(e,t,"B","H","LCD_SEG19")
elseif o==7 then
...
e={}
e["pin_no"]="7"
e["texts"]={"PC.0","LCD_SEG18","SPI0_SS1","I2C0_SCL","PWM0_CH0"}
if o==8 then
...
e={}
e["pin_no"]="8"
e["texts"]={"PC.1","LCD_SEG17","I2C0_SDA","PWM0_CH1"}
if o==8 then
...
e={}
e["pin_no"]="9"
e["texts"]={"PC.2","LCD_SEG16","I2C1_SCL","PWM0_CH2"}
if o==8 then
...
e={}
e["pin_no"]="10"
e["texts"]={"PC.3","LCD_SEG15","I2C1_SDA","PWM0_CH3"}
if o==8 then
...
e={}
e["pin_no"]="11"
e["texts"]={"PC.4","LCD_SEG14","UART1_CTSn","SC0_CLK","INT0"}
if o==8 then
fill_Nano100_LCD(e,t,"C","L","LCD_SEG14")
elseif o==7 then
...
e["texts"]={"PC.4","LCD_SEG14","UART1_CTSn","SC0_UART_TXD","INT0"}
...
e={}
e["pin_no"]="12"
e["texts"]={"PC.5","LCD_SEG13","SC0_CD"}
if o==8 then
fill_Nano100_LCD(e,t,"C","L","LCD_SEG13")
elseif o==4 then
...
e={}
e["pin_no"]="13"
e["texts"]={"PC.6","LCD_SEG12","UART1_RTSn","SC0_DAT"}
if o==8 then
fill_Nano100_LCD(e,t,"C","L","LCD_SEG12")
elseif o==7 then
...
e["texts"]={"PC.6","LCD_SEG12","UART1_RTSn","SC0_UART_RXD"}
e["highlight_color"]=kColor_UART
e["pin_bg_color"]=kBgColor_UART
e["direction"]=kPinDirection_Unknown
end
...
e={}
e["pin_no"]="14"
e["texts"]={"PC.7","LCD_SEG11","UART1_RXD","SC0_PWR"}
if o==8 then
...
e={}
e["pin_no"]="15"
e["texts"]={"PC.8","LCD_SEG10","UART1_TXD","SC0_RST"}
if o==8 then
...
e={}
e["pin_no"]="58"
e["texts"]={"I2C1_SCL","SPI1_CLK","LCD_SEG31","ACMP0_CHDIS","PA.14"}
if o==9 then
fill_Nano100_ACMP(e,t,"A","H","ACMP0_CHDIS")
e["direction"]=kPinDirection_PushPullOut
elseif o==8 then
fill_Nano100_LCD(e,t,"A","H","LCD_SEG31")
elseif o==6 then
...
e={}
e["pin_no"]="59"
e["texts"]={"TC3","ACMP1_OUT","I2C1_SDA","SPI1_SS0","LCD_SEG30","PA.15"}
if o==8 then
fill_Nano100_LCD(e,t,"A","H","LCD_SEG30")
elseif o==6 then
...
e={}
e["pin_no"]="60"
e["texts"]={"FCLK1","UART0_TXD","LCD_SEG29","PB.0"}
if o==8 then
fill_Nano100_LCD(e,t,"B","L","LCD_SEG29")
elseif o==7 then
...
e={}
e["pin_no"]="61"
e["texts"]={"INT1","TC2","UART0_RXD","LCD_SEG28","PB.1"}
if o==8 then
fill_Nano100_LCD(e,t,"B","L","LCD_SEG28")
elseif o==7 then
...
e={}
e["pin_no"]="62"
e["texts"]={"TM3","I2C0_SCL","SPI1_MOSI1","UART0_RTSn","LCD_SEG27","PB.2"}
if o==8 then
fill_Nano100_LCD(e,t,"B","L","LCD_SEG27")
elseif o==7 then
...
e={}
e["pin_no"]="63"
e["texts"]={"TM2","I2C0_SDA","SPI1_MISO1","UART0_CTSn","LCD_SEG26","PB.3"}
if o==8 then
fill_Nano100_LCD(e,t,"B","L","LCD_SEG26")
elseif o==7 then
...
e={}
e["pin_no"]="64"
e["texts"]={"FCLK0","SPI1_SS1","UART1_TXD","LCD_SEG25","PB.6"}
if o==8 then
fill_Nano100_LCD(e,t,"B","L","LCD_SEG25")
elseif o==7 then
