...
dofile(e.."M051.lua")
function get_chip_status_M051_DN_LQFP48(h,e,t,o)
local a={}
...
e={}
e["pin_no"]="1"
e["texts"]={"P1.5","MOSI_0","AIN5","ACMP0_P"}
if o==0 and i==0 then
...
fill_M051_ACMP(e,t,1,5,"ACMP0_P",0)
end
a[1]=e
...
e={}
e["pin_no"]="2"
e["texts"]={"P1.6","MISO_0","AIN6","ACMP2_N"}
if o==0 and i==0 then
...
elseif o==1 and i==1 then
fill_M051_ACMP(e,t,1,6,"ACMP2_N",2)
end
a[2]=e
...
e={}
e["pin_no"]="3"
e["texts"]={"P1.7","SPICLK0","AIN7","ACMP2_P"}
if o==0 and i==0 then
...
elseif o==1 and i==1 then
fill_M051_ACMP(e,t,1,7,"ACMP2_P",2)
end
a[3]=e
e={}
e["pin_no"]="4"
...
e["direction"]=kPinDirection_In
elseif o==1 and i==0 then
fill_M051_ACMP(e,t,3,0,"ACMP1_N",1)
else
...
fill_M051_ACMP(e,t,3,1,"ACMP1_P",1)
else
...
elseif i==1 and o==1 then
fill_M051_ACMP(e,t,3,6,"ACMP0_O",0)
e["direction"]=kPinDirection_PushPullOut
end
a[13]=e
...
e={}
e["pin_no"]="26"
e["texts"]={"ACMP1_O","AD14","PWM6","P2.6"}
if i==0 and o==0 then
...
e["direction"]=kPinDirection_Bi
elseif i==1 and o==1 then
fill_M051_ACMP(e,t,2,6,"ACMP1_O",1)
e["direction"]=kPinDirection_PushPullOut
end
a[26]=e
...
a[27]=e
local i=ext.rshift(ext.band(t["GCR_P4_MFP"],4096),12)
local o=ext.rshift(ext.band(t["GCR_P4_MFP"],16),4)
e={}
e["pin_no"]="28"
e["texts"]={"SCL1","/CS","P4.4"}
if i==0 and o==0 then
...
e["direction"]=kPinDirection_In
elseif n==1 and o==0 and i==0 then
fill_M051_ACMP(e,t,0,1,"ACMP3_N",3)
else
fill_invalid_GPIO(e,t,0,1)
end
a[39]=e
local o=ext.rshift(ext.band(t["GCR_P0_MFP"],16777216),24)
local n=ext.rshift(ext.band(t["GCR_P0_MFP"],256),8)
local i=ext.band(t["GCR_P0_MFP"],1)
e={}
e["pin_no"]="40"
e["texts"]={"ACMP3_P","TXD1","AD0","CTS1","P0.0"}
...
fill_M051_ACMP(e,t,0,0,"ACMP3_P",3)
else
...
e={}
e["pin_no"]="47"
e["texts"]={"ACMP0_N","AIN4","SPISS0","P1.4"}
if i==0 and o==0 then
...
elseif i==1 and o==1 then
fill_M051_ACMP(e,t,1,4,"ACMP0_N",0)
end
a[47]=e
