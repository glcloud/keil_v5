...
function get_chip_status_Nano103_AN_LQFP64(i,t,e,o)
local a={}
local t=read_Nano103_Registers(i,t,e,o)
local e
local o=ext.rshift(ext.band(t["SYS_GPB_MFPH"],251658240),24)
e={}
e["pin_no"]="1"
e["texts"]={"PB.14","INT0","SPI2_MOSI1","SPI2_SS1"}
if o==1 then
...
elseif o==3 then
fill_Nano103_SPI(e,t,"B","H","SPI2_MOSI1",2)
fill_Nano103_SPI_IO(e,t,2,false)
elseif o==4 then
fill_Nano103_SPI(e,t,"B","H","SPI2_SS1",2)
elseif o==0 then
fill_Nano103_GPIO(e,t,"B",14)
else
fill_invalid_GPIO(e,t,"B",14)
end
a[1]=e
local o=ext.rshift(ext.band(t["SYS_GPB_MFPH"],15728640),20)
e={}
e["pin_no"]="2"
e["texts"]={"PB.13","SPI2_MISO1","SNOOPER"}
if o==3 then
fill_Nano103_SPI(e,t,"B","H","SPI2_MISO1",2)
...
a[11]=e
local o=ext.rshift(ext.band(t["SYS_GPB_MFPL"],251658240),24)
e={}
e["pin_no"]="12"
e["texts"]={"PB.6","UART1_RTSn","SPI2_MISO0"}
if o==1 then
fill_Nano103_UART(e,t,"B","L","UART1_RTSn",1)
elseif o==4 then
fill_Nano103_SPI(e,t,"B","L","SPI2_MISO0",2)
fill_Nano103_SPI_IO(e,t,2,true)
elseif o==0 then
fill_Nano103_GPIO(e,t,"B",6)
else
fill_invalid_GPIO(e,t,"B",6)
end
a[12]=e
local o=ext.rshift(ext.band(t["SYS_GPB_MFPL"],4026531840),28)
e={}
e["pin_no"]="13"
e["texts"]={"PB.7","UART1_CTSn"}
if o==1 then
fill_Nano103_UART(e,t,"B","L","UART1_CTSn",1)
elseif o==0 then
fill_Nano103_GPIO(e,t,"B",7)
else
...
a[20]=e
local o=ext.rshift(ext.band(t["SYS_GPD_MFPL"],251658240),24)
e={}
e["pin_no"]="21"
e["texts"]={"PD.6","SPI1_MOSI1","SC1_RST"}
if o==3 then
fill_Nano103_SPI(e,t,"D","L","SPI1_MOSI1",1)
fill_Nano103_SPI_IO(e,t,1,false)
elseif o==4 then
fill_Nano103_SC(e,t,"D","L","SC1_RST",1)
elseif o==0 then
fill_Nano103_GPIO(e,t,"D",6)
else
fill_invalid_GPIO(e,t,"D",6)
end
a[21]=e
local o=ext.rshift(ext.band(t["SYS_GPD_MFPL"],4026531840),28)
e={}
e["pin_no"]="22"
e["texts"]={"PD.7","SPI1_MISO1","SC1_PWR"}
if o==3 then
fill_Nano103_SPI(e,t,"D","L","SPI1_MISO1",1)
fill_Nano103_SPI_IO(e,t,1,true)
elseif o==4 then
fill_Nano103_SC(e,t,"D","L","SC1_PWR",1)
elseif o==0 then
fill_Nano103_GPIO(e,t,"D",7)
else
fill_invalid_GPIO(e,t,"D",7)
end
a[22]=e
local o=ext.rshift(ext.band(t["SYS_GPD_MFPH"],251658240),24)
e={}
e["pin_no"]="23"
e["texts"]={"PD.14","SPI0_MOSI1"}
if o==1 then
fill_Nano103_SPI(e,t,"D","H","SPI0_MOSI1",0)
fill_Nano103_SPI_IO(e,t,0,false)
elseif o==0 then
fill_Nano103_GPIO(e,t,"D",14)
else
fill_invalid_GPIO(e,t,"D",14)
end
a[23]=e
local o=ext.rshift(ext.band(t["SYS_GPD_MFPH"],4026531840),28)
local n=ext.band(t["SC1_SCn_UARTCTL"],1)
e={}
e["pin_no"]="24"
e["texts"]={"PD.15","SPI0_MISO1","SC1_CLK"}
if o==1 then
fill_Nano103_SPI(e,t,"D","H","SPI0_MISO1",0)
fill_Nano103_SPI_IO(e,t,0,true)
elseif o==4 then
if n==0 then
fill_Nano103_SC(e,t,"D","H","SC1_CLK",1)
else
fill_Nano103_SC(e,t,"D","H","SC1_UART_TXD",1)
e["texts"]={"PD.15","SPI0_MISO1","SC1_UART_TXD"}
e["highlight_color"]=kColor_UART
e["pin_bg_color"]=kBgColor_UART
e["direction"]=kPinDirection_PushPullOut
end
elseif o==0 then
fill_Nano103_GPIO(e,t,"D",15)
else
...
a[32]=e
local o=ext.rshift(ext.band(t["SYS_GPC_MFPH"],61440),12)
e={}
e["pin_no"]="33"
e["texts"]={"UART1_TXD","SPI1_MOSI0","PC.11"}
if o==1 then
fill_Nano103_SPI(e,t,"C","H","SPI1_MOSI0",1)
fill_Nano103_SPI_IO(e,t,1,false)
elseif o==5 then
fill_Nano103_UART(e,t,"C","H","UART1_TXD",1)
e["direction"]=kPinDirection_PushPullOut
elseif o==0 then
fill_Nano103_GPIO(e,t,"C",11)
else
fill_invalid_GPIO(e,t,"C",11)
end
a[33]=e
local o=ext.rshift(ext.band(t["SYS_GPC_MFPH"],3840),8)
e={}
e["pin_no"]="34"
e["texts"]={"UART1_RXD","SPI1_MISO0","PC.10"}
if o==1 then
fill_Nano103_SPI(e,t,"C","H","SPI1_MISO0",1)
fill_Nano103_SPI_IO(e,t,1,true)
elseif o==5 then
fill_Nano103_UART(e,t,"C","H","UART1_RXD",1)
e["direction"]=kPinDirection_In
elseif o==0 then
fill_Nano103_GPIO(e,t,"C",10)
else
fill_invalid_GPIO(e,t,"C",10)
end
a[34]=e
local o=ext.rshift(ext.band(t["SYS_GPC_MFPH"],240),4)
e={}
e["pin_no"]="35"
e["texts"]={"I2C1_SCL","SPI1_SCLK","PC.9"}
if o==1 then
fill_Nano103_SPI(e,t,"C","H","SPI1_SCLK",1)
elseif o==5 then
fill_Nano103_I2C(e,t,"C","H","I2C1_SCL",1)
elseif o==0 then
fill_Nano103_GPIO(e,t,"C",9)
else
fill_invalid_GPIO(e,t,"C",9)
end
a[35]=e
local o=ext.band(t["SYS_GPC_MFPH"],15)
e={}
e["pin_no"]="36"
e["texts"]={"I2C1_SDA","SPI1_SS0","PC.8"}
if o==1 then
fill_Nano103_SPI(e,t,"C","H","SPI1_SS0",1)
elseif o==5 then
fill_Nano103_I2C(e,t,"C","H","I2C1_SDA",1)
elseif o==0 then
fill_Nano103_GPIO(e,t,"C",8)
else
...
a[54]=e
local o=ext.rshift(ext.band(t["SYS_GPC_MFPH"],4026531840),28)
e={}
e["pin_no"]="55"
e["texts"]={"TM0_CAP_IN","UART1_RTSn","PC.15"}
if o==1 then
fill_Nano103_UART(e,t,"C","H","UART1_RTSn",1)
elseif o==3 then
fill_Nano103_TM(e,t,"C","H","TM0_CAP_IN",0,0)
e["direction"]=kPinDirection_In
elseif o==0 then
fill_Nano103_GPIO(e,t,"C",15)
else
fill_invalid_GPIO(e,t,"C",15)
end
a[55]=e
local o=ext.rshift(ext.band(t["SYS_GPC_MFPH"],251658240),24)
e={}
e["pin_no"]="56"
e["texts"]={"UART1_CTSn","PC.14"}
if o==1 then
fill_Nano103_UART(e,t,"C","H","UART1_CTSn",1)
elseif o==0 then
fill_Nano103_GPIO(e,t,"C",14)
else
