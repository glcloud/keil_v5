...
dofile(e.."M2351.lua")
function get_chip_status_M2351_AE_LQFP128(i,t,o,e)
local a={}
local t=read_M2351_Registers(i,t,o,e)
local e
...
elseif o==1 then
fill_M2351_EADC(e,t,"B",1,"EADC0_CH1")
elseif o==2 then
...
elseif o==1 then
fill_M2351_EADC(e,t,"B",0,"EADC0_CH0")
elseif o==2 then
...
elseif o==1 then
fill_M2351_ACMP(e,t,"A",11,"ACMP0_P0",0)
elseif o==2 then
...
elseif o==1 then
fill_M2351_ACMP(e,t,"A",10,"ACMP1_P0",1)
elseif o==2 then
...
e["direction"]=kPinDirection_PushPullOut
elseif o==14 then
fill_M2351_EADC(e,t,"C",13,"EADC0_ST")
else
...
e["direction"]=kPinDirection_PushPullOut
elseif o==14 then
fill_M2351_EADC(e,t,"D",12,"EADC0_ST")
elseif o==15 then
...
e={}
e["pin_no"]="19"
e["texts"]={"PD.11","EBI_nCS1","UART1_TXD","CAN0_TXD","QEI0_A","INT6"}
if o==0 then
...
e["direction"]=kPinDirection_PushPullOut
elseif o==4 then
fill_M2351_CAN(e,t,"D",11,"CAN0_TXD",0)
e["direction"]=kPinDirection_PushPullOut
elseif o==10 then
...
e={}
e["pin_no"]="20"
e["texts"]={"PD.10","EBI_nCS2","UART1_RXD","CAN0_RXD","QEI0_B","INT7"}
if o==0 then
...
e["direction"]=kPinDirection_In
elseif o==4 then
fill_M2351_CAN(e,t,"D",10,"CAN0_RXD",0)
e["direction"]=kPinDirection_In
elseif o==10 then
...
e["direction"]=kPinDirection_In
elseif o==11 then
fill_M2351_EADC(e,t,"F",5,"EADC0_ST")
else
...
e={}
e["pin_no"]="55"
e["texts"]={"PA.5","QSPI0_MISO1","SPI1_I2SMCLK","SC2_nCD","UART0_nCTS","UART5_TXD","I2C0_SCL","CAN0_TXD","BPWM0_CH5","EPWM0_CH0","QEI0_INDEX"}
if o==0 then
...
elseif o==10 then
fill_M2351_CAN(e,t,"A",5,"CAN0_TXD",0)
e["direction"]=kPinDirection_PushPullOut
elseif o==12 then
...
e={}
e["pin_no"]="56"
e["texts"]={"PA.4","QSPI0_MOSI1","SPI0_I2SMCLK","SC0_nCD","UART0_nRTS","UART5_RXD","I2C0_SDA","CAN0_RXD","BPWM0_CH4","EPWM0_CH1","QEI0_A"}
if o==0 then
...
elseif o==10 then
fill_M2351_CAN(e,t,"A",4,"CAN0_RXD",0)
e["direction"]=kPinDirection_In
elseif o==12 then
...
e={}
e["pin_no"]="62"
e["texts"]={"PE.14","EBI_AD8","UART2_TXD","CAN0_TXD"}
if o==0 then
...
e["direction"]=kPinDirection_PushPullOut
elseif o==4 then
fill_M2351_CAN(e,t,"E",14,"CAN0_TXD",0)
e["direction"]=kPinDirection_PushPullOut
else
...
e["direction"]=kPinDirection_In
elseif o==4 then
fill_M2351_CAN(e,t,"E",15,"CAN0_RXD",0)
e["direction"]=kPinDirection_In
else
...
e={}
e["pin_no"]="69"
e["texts"]={"EPWM1_CH0","UART4_TXD","CAN0_TXD","I2C1_SCL","UART2_TXD","QSPI0_MISO1","EBI_AD5","PC.5"}
if o==0 then
...
elseif o==10 then
fill_M2351_CAN(e,t,"C",5,"CAN0_TXD",0)
e["direction"]=kPinDirection_PushPullOut
elseif o==11 then
...
e={}
e["pin_no"]="70"
e["texts"]={"EPWM1_CH1","UART4_RXD","CAN0_RXD","I2C1_SDA","UART2_RXD","SPI1_I2SMCLK","I2S0_BCLK","SC1_nCD","QSPI0_MOSI1","EBI_AD4","PC.4"}
if o==0 then
...
elseif o==10 then
fill_M2351_CAN(e,t,"C",4,"CAN0_RXD",0)
e["direction"]=kPinDirection_In
elseif o==11 then
...
e={}
e["pin_no"]="71"
e["texts"]={"EPWM1_CH2","UART3_TXD","I2C0_SMBAL","UART2_nRTS","SPI1_MISO","I2S0_MCLK","SC1_PWR","QSPI0_SS","EBI_AD3","PC.3"}
if o==0 then
...
e={}
e["pin_no"]="72"
e["texts"]={"EPWM1_CH3","UART3_RXD","I2C0_SMBSUS","UART2_nCTS","SPI1_MOSI","I2S0_DI","SC1_RST","QSPI0_CLK","EBI_AD2","PC.2"}
if o==0 then
...
e={}
e["pin_no"]="73"
e["texts"]={"ACMP0_O","EPWM1_CH4","I2C0_SCL","UART2_TXD","SPI1_CLK","I2S0_DO","SC1_DAT","QSPI0_MISO0","EBI_AD1","PC.1"}
if o==0 then
...
e={}
e["pin_no"]="74"
e["texts"]={"ACMP1_O","EPWM1_CH5","I2C0_SDA","UART2_RXD","SPI1_SS","I2S0_LRCK","SC1_CLK","QSPI0_MOSI0","EBI_AD0","PC.0"}
if o==0 then
...
e["direction"]=kPinDirection_PushPullOut
elseif o==15 then
fill_M2351_EADC(e,t,"G",15,"EADC0_ST")
else
...
e={}
e["pin_no"]="87"
e["texts"]={"USB_VBUS_ST","SC1_CLK","USCI1_CTL1","SPI1_SS","I2C1_SDA","USCI0_CTL0","PD.4"}
if o==0 then
...
elseif o==14 then
fill_M2351_USB(e,t,"D",4,"USB_VBUS_ST")
else
...
elseif o==14 then
fill_M2351_USB(e,t,"A",12,"USB_VBUS")
else
...
elseif o==14 then
fill_M2351_USB(e,t,"A",15,"USB_OTG_ID")
else
...
elseif o==1 then
fill_M2351_EADC(e,t,"B",15,"EADC0_CH15")
elseif o==2 then
...
elseif o==14 then
fill_M2351_USB(e,t,"B",15,"USB_VBUS_EN")
else
...
elseif o==1 then
fill_M2351_EADC(e,t,"B",14,"EADC0_CH14")
elseif o==2 then
...
e["direction"]=kPinDirection_PushPullOut
elseif o==15 then
fill_M2351_USB(e,t,"B",14,"USB_VBUS_ST")
else
...
e={}
e["pin_no"]="123"
e["texts"]={"SPI3_CLK","BPWM1_CH0","SPI0_I2SMCLK","CAN0_TXD","I2C1_SCL","UART4_TXD","UART0_nCTS","EBI_ADR16","EADC0_CH11","PB.11"}
if o==0 then
fill_M2351_GPIO(e,t,"B",11)
elseif o==1 then
fill_M2351_EADC(e,t,"B",11,"EADC0_CH11")
elseif o==2 then
...
elseif o==8 then
fill_M2351_CAN(e,t,"B",11,"CAN0_TXD",0)
e["direction"]=kPinDirection_PushPullOut
elseif o==9 then
...
e={}
e["pin_no"]="124"
e["texts"]={"SPI3_SS","BPWM1_CH1","CAN0_RXD","I2C1_SDA","UART4_RXD","UART0_nRTS","USCI1_CTL0","EBI_ADR17","EADC0_CH10","PB.10"}
if o==0 then
fill_M2351_GPIO(e,t,"B",10)
elseif o==1 then
fill_M2351_EADC(e,t,"B",10,"EADC0_CH10")
elseif o==2 then
...
elseif o==8 then
fill_M2351_CAN(e,t,"B",10,"CAN0_RXD",0)
e["direction"]=kPinDirection_In
elseif o==10 then
...
elseif o==1 then
fill_M2351_EADC(e,t,"B",9,"EADC0_CH9")
elseif o==2 then
...
elseif o==1 then
fill_M2351_EADC(e,t,"B",8,"EADC0_CH8")
elseif o==2 then
...
elseif o==1 then
fill_M2351_EADC(e,t,"B",7,"EADC0_CH7")
elseif o==2 then
...
e["direction"]=kPinDirection_In
elseif o==14 then
fill_M2351_USB(e,t,"B",7,"USB_VBUS_ST")
elseif o==15 then
...
e={}
e["pin_no"]="128"
e["texts"]={"ACMP1_O","USB_VBUS_EN","INT4","EPWM1_CH5","EPWM1_BRAKE1","BPWM1_CH5","EBI_nCS1","UART1_RXD","USCI1_DAT1","EBI_nWRH","EADC0_CH6","PB.6"}
if o==0 then
fill_M2351_GPIO(e,t,"B",6)
elseif o==1 then
fill_M2351_EADC(e,t,"B",6,"EADC0_CH6")
elseif o==2 then
...
e["direction"]=kPinDirection_In
elseif o==14 then
fill_M2351_USB(e,t,"B",6,"USB_VBUS_EN")
elseif o==15 then
