...
dofile(e.."M031.lua")
function get_chip_status_M031_16K_AE_QFN33(i,o,e,t)
local a={}
local t=read_M031_Registers(i,o,e,t)
local e
...
e={}
e["pin_no"]="4"
e["texts"]={"PB.2","EADC0_CH2","I2C1_SDA","UART1_RXD","PWM0_CH3","INT3"}
if o==0 then
...
e={}
e["pin_no"]="15"
e["texts"]={"PF.15","PWM0_BRAKE0","PWM0_CH1","CLKO","INT4"}
if o==0 then
...
e={}
e["pin_no"]="30"
e["texts"]={"UART0_TXD","SPI0_MISO","EADC0_CH13","PB.13"}
if o==0 then
...
e={}
e["pin_no"]="31"
e["texts"]={"UART0_RXD","SPI0_MOSI","EADC0_CH12","PB.12"}
if o==0 then
