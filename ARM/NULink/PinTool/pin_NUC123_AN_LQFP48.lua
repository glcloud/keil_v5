...
dofile(e.."NUC123.lua")
function get_chip_status_NUC123_AN_LQFP48(n,e,o,t)
local a={}
...
a[6]=e
local i=ext.rshift(ext.band(t["GCR_GPB_MFP"],32),5)
...
a[25]=e
local i=ext.rshift(ext.band(t["GCR_GPC_MFP"],4096),12)
...
local i=ext.rshift(ext.band(t["GCR_ALT_MFP1"],65536),16)
e={}
e["pin_no"]="38"
...
a[38]=e
local i=ext.rshift(ext.band(t["GCR_GPD_MFP"],2),1)
...
local i=ext.rshift(ext.band(t["GCR_ALT_MFP1"],1048576),20)
e={}
e["pin_no"]="42"
...
a[42]=e
local i=ext.rshift(ext.band(t["GCR_GPD_MFP"],32),5)
