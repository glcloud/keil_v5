...
dofile(e.."NUC131.lua")
function get_chip_status_NUC131_AE_LQFP64(r,t,o,e)
local a={}
...
a[4]=e
local o=ext.rshift(ext.band(t["GCR_ALT_MFP3"],1024),10)
local i=ext.rshift(ext.band(t["GCR_GPF_MFP"],16),4)
e={}
e["pin_no"]="5"
...
a[7]=e
local o=ext.rshift(ext.band(t["GCR_ALT_MFP4"],2),1)
local i=ext.rshift(ext.band(t["GCR_GPA_MFP"],512),9)
e={}
e["pin_no"]="8"
...
e={}
e["pin_no"]="21"
e["texts"]={"PD.6","CAN0_RXD","BPWM1_CH1"}
if o==0 and i==0 then
fill_NUC131_GPIO(e,t,"D",6,nil,"GCR_ALT_MFP3")
elseif o==0 and i==1 then
fill_NUC131_CAN(e,t,"D",6,"CAN0_RXD",0,"GCR_ALT_MFP3")
elseif o==1 and i==1 then
...
e={}
e["pin_no"]="22"
e["texts"]={"PD.7","CAN0_TXD","BPWM1_CH0"}
if o==0 and i==0 then
fill_NUC131_GPIO(e,t,"D",7,nil,"GCR_ALT_MFP3")
elseif o==0 and i==1 then
fill_NUC131_CAN(e,t,"D",7,"CAN0_TXD",0,"GCR_ALT_MFP3")
elseif o==1 and i==1 then
...
a[24]=e
local i=ext.rshift(ext.band(t["GCR_ALT_MFP3"],32768),15)
...
a[50]=e
local o=ext.rshift(ext.band(t["GCR_ALT_MFP4"],16384),14)
local i=ext.rshift(ext.band(t["GCR_GPA_MFP"],128),7)
e={}
e["pin_no"]="51"
