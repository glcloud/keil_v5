...
dofile(e.."M0564.lua")
function get_chip_status_M0564_AE_LQFP100(i,o,e,t)
local a={}
local t=read_M0564_Registers(i,o,e,t)
local e
...
e={}
e["pin_no"]="57"
e["texts"]={"TM_BRAKE0","SC1_RST","UART1_TXD","PA.8"}
if o==0 then
...
e={}
e["pin_no"]="58"
e["texts"]={"TM_BRAKE1","SC1_PWR","UART1_RXD","PA.9"}
if o==0 then
