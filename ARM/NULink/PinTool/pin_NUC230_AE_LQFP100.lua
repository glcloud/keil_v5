...
dofile(e.."NUC200.lua")
function get_chip_status_NUC230_AE_LQFP100(d,e,o,t)
local a={}
...
a[33]=e
local r=ext.rshift(ext.band(t["GCR_ALT_MFP"],8192),13)
...
if r==0 and h==0 and s==0 and o==0 and i==0 and n==0 then
fill_NUC200_GPIO(e,t,"B",2,nil,"GCR_ALT_MFP","GCR_ALT_MFP2")
elseif r==0 and h==0 and s==0 and o==0 and i==0 and n==1 then
fill_NUC200_UART(e,t,"B",2,"UART0_nRTS",0,"GCR_ALT_MFP","GCR_ALT_MFP2")
elseif r==0 and h==0 and s==0 and o==0 and i==1 and n==1 then
fill_NUC200_TM(e,t,"B",2,"TM2_EXT",2,"GCR_ALT_MFP","GCR_ALT_MFP2")
elseif r==0 and h==0 and s==0 and o==1 and i==0 and n==1 then
fill_NUC200_ACMP(e,t,"B",2,"ACMP0_O","GCR_ALT_MFP","GCR_ALT_MFP2")
e["direction"]=kPinDirection_PushPullOut
elseif r==1 and h==1 and s==0 and o==0 and i==0 and n==1 then
...
local n=ext.rshift(ext.band(t["GCR_ALT_MFP"],2048),11)
local i=ext.rshift(ext.band(t["GCR_ALT_MFP2"],32),5)
