...
dofile(e.."M031.lua")
function get_chip_status_M031_16K_AE_TSSOP28(i,t,e,o)
local a={}
local t=read_M031_Registers(i,t,e,o)
local e
...
e={}
e["pin_no"]="14"
e["texts"]={"PB.3","EADC0_CH3","I2C1_SCL","UART1_TXD","PWM0_CH2","PWM0_BRAKE0","INT2"}
if o==0 then
...
e={}
e["pin_no"]="15"
e["texts"]={"INT3","PWM0_CH3","UART1_RXD","I2C1_SDA","EADC0_CH2","PB.2"}
if o==0 then
...
e={}
e["pin_no"]="16"
e["texts"]={"PWM0_BRAKE0","PWM0_CH4","I2C1_SCL","UART2_TXD","EADC0_CH1","PB.1"}
if o==0 then
...
e={}
e["pin_no"]="17"
e["texts"]={"PWM0_BRAKE1","PWM0_CH5","I2C1_SDA","SPI0_I2SMCLK","UART2_RXD","EADC0_CH0","PB.0"}
if o==0 then
...
e={}
e["pin_no"]="9"
e["texts"]={"PB.13","EADC0_CH13","SPI0_MISO","UART0_TXD"}
if o==0 then
...
e={}
e["pin_no"]="10"
e["texts"]={"PB.12","EADC0_CH12","SPI0_MOSI","UART0_RXD"}
if o==0 then
