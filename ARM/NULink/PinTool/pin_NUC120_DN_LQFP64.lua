...
dofile(e.."NUC100.lua")
function get_chip_status_NUC120_DN_LQFP64(r,e,t,o)
local a={}
...
elseif s==0 and o==0 and i==1 and n==0 then
...
elseif s==1 and o==1 and i==1 and n==0 then
...
local i=ext.rshift(ext.band(t["GCR_ALT_MFP1"],16384),14)
...
if o==0 and n==0 and i==0 and s==0 and h==0 then
fill_NUC100_GPIO(e,t,"B",3,nil,"GCR_ALT_MFP","GCR_ALT_MFP1")
elseif o==0 and n==0 and i==0 and s==0 and h==1 then
fill_NUC100_UART(e,t,"B",3,"CTS0",0,"GCR_ALT_MFP","GCR_ALT_MFP1")
elseif o==0 and n==0 and i==0 and s==1 and h==1 then
fill_NUC100_TM(e,t,"B",3,"T3EX",3,"GCR_ALT_MFP","GCR_ALT_MFP1")
elseif o==0 and n==0 and i==1 and s==0 and h==1 then
fill_NUC100_SC(e,t,"B",3,"SC2CD",2,"GCR_ALT_MFP","GCR_ALT_MFP1")
e["direction"]=kPinDirection_In
elseif o==1 and n==1 and i==0 and s==0 and h==1 then
...
a[35]=e
local i=ext.rshift(ext.band(t["GCR_ALT_MFP"],4096),12)
local n=ext.rshift(ext.band(t["GCR_ALT_MFP"],2048),11)
...
local s=ext.rshift(ext.band(t["GCR_GPA_MFP"],4),2)
e={}
e["pin_no"]="46"
