...
dofile(e.."NM1500.lua")
function get_chip_status_M0519_AE_LQFP48(n,e,t,o)
local a={}
...
local i=ext.rshift(ext.band(t["GCR_PA_MFP"],512),9)
e={}
e["pin_no"]="9"
...
a[9]=e
local i=ext.band(t["GCR_PA_MFP"],1)
...
a[23]=e
local i=ext.rshift(ext.band(t["GCR_P6_MFP"],128),7)
local o=ext.rshift(ext.band(t["GCR_P6_MFP"],32768),15)
e={}
e["pin_no"]="24"
e["texts"]={"P6.7","EADC0_CH7"}
if o==0 and i==0 then
...
local i=ext.rshift(ext.band(t["GCR_P6_MFP"],4096),12)
e={}
e["pin_no"]="27"
...
a[28]=e
local i=ext.rshift(ext.band(t["GCR_P6_MFP"],4),2)
...
local i=ext.rshift(ext.band(t["GCR_P8_MFP"],1024),10)
e={}
e["pin_no"]="32"
e["texts"]={"OP0_O","P8.2"}
if i==0 and o==0 then
...
local i=ext.rshift(ext.band(t["GCR_P8_MFP"],512),9)
e={}
e["pin_no"]="33"
e["texts"]={"OP0_N","P8.1"}
if i==0 and o==0 then
